...
class MenstrualTracker:
    ...
    def predict_next(self):
        ...
        med_cycle = statistics.median(intervals) 
        
        # Predikce dalšího data
        last_date = datetime.strptime(self.cycles[0], "%Y-%m-%d")
        next_date = last_date + timedelta(days=int(med_cycle))
        
        return next_date, med_cycle
...
def main(page: ft.Page):
    ...
    # Eventhandler: add date function
    def add_date(e):
    ...
    def update_prediction():
        ...
        if next_date:
            ...
            prediction_text.value = "⚠️ No prediction available until at least 2 record are added"
